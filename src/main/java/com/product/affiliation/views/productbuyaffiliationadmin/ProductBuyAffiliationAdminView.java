package com.product.affiliation.views.productbuyaffiliationadmin;
...
@PageTitle("Product Buy Affiliation Admin")
@Route(value = "product-buy-affiliation-admin")
@RouteAlias(value = "")
public class ProductBuyAffiliationAdminView extends Div {
    ...
    public ProductBuyAffiliationAdminView() {
        addClassName("product-buy-affiliation-admin-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
